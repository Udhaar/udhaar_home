  ...
  return (
    <div className="flex flex-col pt-3 md:py-3 md:flex-row justify-between px-3 mb-3 md:mb-0 bg-[#afd6fe]">
      <div className="flex md:w-max w-full justify-between">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" onClick={() => { setNavbarVisible(!navbarVisible)}} className="h-7 w-7 md:hidden self-center " viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM9 15a1 1 0 011-1h6a1 1 0 110 2h-6a1 1 0 01-1-1z" clipRule="evenodd" />
        </svg>
      </div>
      <div className={`flex flex-col md:flex-row items-center gap-5 md:mt-0 mt-3 transition-all ease-in-out duration-500 ${!navbarVisible? `max-h-0 md:max-h-52`:`max-h-52`} overflow-hidden`}>
